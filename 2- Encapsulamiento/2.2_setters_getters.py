# SETTERS Y GETTERS
# Son una convención utilizada en la programación orientada a objetos para proporcionar acceso controlado a los atributos de una clase.
...
cuenta_abel = CuentaBancaria("Abel Tomás", 1000)

# Obtener el titular y el saldo utilizando los getters
print(f"Titular: {cuenta_abel.obtener_titular()}")    # Abel Tomás
...
# Hay dos métodos "getter" (obtener_titular y obtener_saldo) y un método "setter" (establecer_saldo) para acceder y modificar estos atributos de manera controlada.
