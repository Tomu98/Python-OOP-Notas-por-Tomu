# MRO ("Method Resolution Order" o "Orden de Resolución de Métodos").
...
# Es crucial para garantizar que los métodos se llamen en el orden correcto y que las clases derivadas hereden y sobrescriban correctamente los métodos de las clases base.
...
# - Depth-First Search (DFS): el algoritmo sigue una estrategia de búsqueda en profundidad para recorrer la jerarquía de clases, significa que primero busca en la clase actual antes de pasar a las superclases.
# - Left-to-Right: Si una subclase hereda de varias superclases, se mantiene el orden en el que se mencionaron las superclases en la declaración de la subclase. Python sigue este orden al calcular la MRO.
...
# Conclusiones
# La MRO (Method Resolution Order) es un concepto fundamental que resuelve el problema de la ambigüedad cuando una subclase hereda de múltiples superclases.
