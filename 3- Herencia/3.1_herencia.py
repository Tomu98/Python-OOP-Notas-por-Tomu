...
# Esto es fundamental en POO para organizar y estructurar el código de manera eficiente.
# Para que una nueva clase herede de una super clase, la sintaxis que deberiamos utilizar sería "class NuevaClase(*Super_Clase*)"
