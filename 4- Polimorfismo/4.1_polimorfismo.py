...
# El polimorfismo en Python se puede lograr de varias maneras:
# Polimorfismo de interfaz: Esto se refiere a tener clases con métodos que tienen el mismo nombre pero diferentes implementaciones, como en el ejemplo de Perro y Gato.
