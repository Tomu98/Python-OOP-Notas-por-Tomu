...
# El enlace se establece antes de que el programa se ejecute y no cambia durante la ejecución del programa.
# Significa que el compilador determina qué función o método se debe llamar en función de la declaración en tiempo de compilación.
